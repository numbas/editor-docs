...
Each question and exam has a selection of download links at the top of its edit page. Click on the :guilabel:`standalone .zip` link to download a package suitable for standalone use on the web.
